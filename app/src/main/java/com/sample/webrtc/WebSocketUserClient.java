...
import com.sample.webrtc.RoomParametersFetcher.RoomParametersFetcherEvents;
import com.sample.webrtc.UserSocketChannel.WebSocketChannelEvents;
import com.sample.webrtc.UserSocketChannel.WebSocketConnectionState;
...
/**
 * Negotiates signaling for chatting with "rooms".
 ...
 */
public class WebSocketUserClient implements UserClient, WebSocketChannelEvents {
  ...
  private UserSocketChannel wsClient;
  private ConnectionState roomState;
  private RoomConnectionParameters connectionParameters;
  private String messageUrl;
  private String leaveUrl;

  public WebSocketUserClient(SignalingEvents events) {
    this.events = events;
  ...
  private void connectToRoomInternal() {
    ...
    roomState = ConnectionState.NEW;
    wsClient = new UserSocketChannel(handler, this);

    RoomParametersFetcherEvents callbacks = new RoomParametersFetcherEvents() {
      @Override
      public void onSignalingParametersReady(final SignalingParameters params) {
        WebSocketUserClient.this.handler.post(new Runnable() {
          @Override
          public void run() {
            WebSocketUserClient.this.signalingParametersReady(params);
          }
        });
      }
      ...
      public void onSignalingParametersError(String description) {
        WebSocketUserClient.this.reportError(description);
      }
    };
